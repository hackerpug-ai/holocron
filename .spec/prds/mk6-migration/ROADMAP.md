...
| 29 | — | [Sprint 29: Cutover — Write Freeze, ETL and Read-Only Soak Flip](#sprint-29-cutover--write-freeze-etl-and-read-only-soak-flip) | App + 44 MCP tools serve reads from Postgres; every write returns `migration_read_only` | 5 | 13, 14, 19, 20, 22, 23, 24, 25, 26, 6 | 🟠 In Progress | `mk6-cutover` | — |
