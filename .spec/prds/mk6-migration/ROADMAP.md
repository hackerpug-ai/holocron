...
| 20 | — | [Sprint 20: E2E Maestro Harness and Cold-Boot Reference Flow](#sprint-20-e2e-maestro-harness-and-cold-boot-reference-flow) | Cold-boot chat round-trips fleet→Postgres→Zero-sync green on real Maestro harness | 10 | 4, 6, 13, 18 | 🟠 In Progress | `mk6-reference-flow` | — |
