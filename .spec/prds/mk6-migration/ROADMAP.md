...
| 24 | — | [Sprint 24: Full RN App Rewrite off Convex onto Zero](#sprint-24-full-rn-app-rewrite-off-convex-onto-zero) | Rewritten app shows 3 seeded conversations via Zero; no Convex hook on the path | 6 | 4, 16, 20, 21 | 🟠 In Progress | `mk6-app-rewrite` | — |
