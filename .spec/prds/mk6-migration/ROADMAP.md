...
| 14 | — | [Sprint 14: Big-Bang ETL and Content-Addressed File Storage](#sprint-14-big-bang-etl-and-content-addressed-file-storage) | `holo etl:run` + `holo etl:reconcile` — zero unexplained variance, 0 orphan FKs | 6 | 2, 4, 7, 10 | 🟠 In Progress | `mk6-etl` | — |
