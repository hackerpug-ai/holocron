...
| 25 | — | [Sprint 25: Reactive Surfaces — SSE Streaming, Mission Progress, Degraded](#sprint-25-reactive-surfaces--sse-streaming-mission-progress-degraded) | Disconnect mid-stream → reconciles to exactly one final message, no dup tokens | 5 | 8, 15, 18, 24 | 🟠 In flight | `mk6-reactive-surfaces` | — |
...
| 27 | — | [Sprint 27: Standing Off-Mini Backup Pipeline and Alerting](#sprint-27-standing-off-mini-backup-pipeline-and-alerting) | Induced backup failure fires an alert within 15 min, no dashboard-polling | 6 | 4, 6 | 🟠 In flight | `mk6-backup` | — |
