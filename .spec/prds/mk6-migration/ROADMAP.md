...
| 19 | — | [Sprint 19: MCP Gateway Rehost — 44 Tools on Postgres](#sprint-19-mcp-gateway-rehost--44-tools-on-postgres) | All 44 MCP tools over stdio on seeded Postgres match manifest; zero Convex calls | 8 | 3, 4, 5 | 🟠 In Progress | `mk6-mcp-rehost` | — |
