...
| 10 | — | [Sprint 10: Local Re-embedding and Hybrid RRF Search](#sprint-10-local-re-embedding-and-hybrid-rrf-search) | Past-8K span retrievable via one-round-trip pgvector+FTS RRF fusion | 5 | 1, 4 | 🟠 In flight | `mk6-local-search` | — |
