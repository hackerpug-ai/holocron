...
| REDHAT-FIX-04 | Validate every mutation replay fixture against its manifest replay key and live Zod schema | mcp-implementer | TBD |
| REDHAT-FIX-05 | Validate mutation error fixture codes against the corresponding manifest error catalog | mcp-implementer | TBD |
...
### Red-Hat Remediation Tasks — Cycle 2 (added 2026-07-14)

Generated by `/kb-sprint-tasks-plan --only REDHAT-FIX-04,REDHAT-FIX-05` on 2026-07-14 (proposed by: mcp-planner; source: `.spec/reviews/red-hat-2026-07-14T19-07-45Z-sprint03-postremediation.md`)

- REDHAT-FIX-04-validate-every-mutation-replay-fixture-against-manifest-replay-key-and-live-zod.md
- REDHAT-FIX-05-validate-mutation-error-fixture-codes-against-manifest-error.md
