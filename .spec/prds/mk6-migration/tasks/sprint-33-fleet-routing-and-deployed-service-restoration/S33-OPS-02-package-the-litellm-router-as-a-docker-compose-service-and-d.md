          ...
          },
          {
            ...
            "action": {
              ...
              "steps": [
                ...
                "in the focused integration test, rerun health-flip with --negative-control fail-after-stop and exact .tmp/S33-OPS-02/health-flip-negative; assert intentional nonzero and every failure.json predicate; the test independently recomputes the raw health triplet ok/true/null -> degraded/false/fleet -> ok/true/null, requires all 3 uptimeMs values to be finite JSON numbers before monotonic comparison, and recomputes all five invariants from the raw named artifacts before bounded fresh health/router checks"
              ]
            },
            "end_state": {
              "must_observe": [
