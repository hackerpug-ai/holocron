import type { Emphasis, InlineCode, Link, Text as MdastText, Strong } from 'mdast';
...
export const LinkRenderer = React.memo(({ node, children, onLinkPress, testID }: LinkProps) => {
...
export const EmphasisRenderer = React.memo(({ children, testID }: EmphasisProps) => {
  return (
    <Text style={{ fontStyle: 'italic' }} testID={testID}>
      {children}
    </Text>
  );
});
...
export const StrongRenderer = React.memo(({ children, testID }: StrongProps) => {
  return (
    <Text style={{ fontWeight: '700' }} testID={testID}>
      {children}
    </Text>
  );
});
...
export const InlineCodeRenderer = React.memo(({ children, testID }: InlineCodeProps) => {
