    ...
    >
      <GestureHandlerRootView style={{ flex: 1 }}>
        ...
        <GestureDetector gesture={panGesture}>
          <Animated.View
            style={[sheetStyle, { paddingBottom: insets.bottom + 16, maxHeight: '60%' }]}
          ...
          >
            ...
            {/* Title */}
            <Text className="text-foreground text-lg font-semibold mb-4">Add to Chat</Text>
            ...
            >
              ...
              <View className="flex-1">
                <Text className="text-foreground text-base font-medium">New Chat</Text>
                <Text className="text-muted-foreground text-sm">Start a fresh conversation</Text>
              </View>
            </Pressable>

            {/* Separator */}
            {conversations.length > 0 && <View className="mx-4 border-b border-border mb-2" />}
