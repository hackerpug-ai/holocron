...
import { AlertTriangle, CheckCircle2, Circle, Loader2 } from '@/components/ui/icons';
  ...
  return (
    <View className={cn('gap-1', className)}>
      <View className="flex-row items-center justify-between">
        ...
        <Text className="text-xs text-muted-foreground font-medium">{percentage}%</Text>
      </View>
  ...
  return (
    ...
    >
      ...
      <CardHeader className="pb-3">
        ...
        <Text className="text-foreground font-semibold text-base mt-1">{title}</Text>
        {description && <Text className="text-muted-foreground text-sm mt-1">{description}</Text>}
      </CardHeader>
            ...
            >
              ...
              {isCompleted && step.resultSummary && (
                <View className="ml-6 pl-2">
                  <Text className="text-muted-foreground text-xs">✓ {step.resultSummary}</Text>
                </View>
              )}
              ...
              {isFailed && step.errorMessage && (
                <View className="ml-6 pl-2">
                  <Text className="text-destructive text-xs">{step.errorMessage}</Text>
                </View>
              )}
              ...
              {isCurrent && (
                <View className="ml-6 pl-2">
                  <Text className="text-primary text-xs font-medium">Running...</Text>
                </View>
              )}
            </View>
          );
