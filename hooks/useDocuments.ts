...
export function mapDocumentCategoryToCategoryType(docCategory: DocumentCategory): CategoryType {
  // Map research-related documents to 'research' category
  if (docCategory === 'research') {
    return 'research'
  }

  // Map all other categories to 'general' for now
  // This can be extended with more specific mappings as needed
  return 'general'
}
