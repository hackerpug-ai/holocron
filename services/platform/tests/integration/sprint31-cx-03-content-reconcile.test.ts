 ...
 *     pnpm test:integration -- services/platform/tests/integration/sprint31-cx-03-content-reconcile.test.ts
 */
...
const FIXTURE_DIR = resolve(REPO_ROOT, 'services/platform/tests/fixtures/s31-cx-03');
