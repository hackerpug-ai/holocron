 ...
 *     services/platform/tests/integration/research-evals-ci-gate.test.ts
 */
...
const DATASET_PATH = resolve(REPO_ROOT, 'services/platform/evals/datasets/research_v1.jsonl');
