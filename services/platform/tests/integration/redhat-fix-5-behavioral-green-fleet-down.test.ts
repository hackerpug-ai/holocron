 ...
 *
 *   PLATFORM_IT=1 pnpm vitest run services/platform/tests/integration/redhat-fix-5-behavioral-green-fleet-down.test.ts
 */
...
const HOLO_CLI_PATH = resolve(REPO_ROOT, 'services/platform/src/cli/holo.ts');
