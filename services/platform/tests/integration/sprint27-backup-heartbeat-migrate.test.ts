 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run services/platform/tests/integration/sprint27-backup-heartbeat-migrate.test.ts
 */
...
const MIGRATION_SQL = resolve(
  REPO_ROOT,
  'services/platform/src/db/migrations/0029_backup_heartbeat.sql'
);
const JOURNAL = resolve(REPO_ROOT, 'services/platform/src/db/migrations/meta/_journal.json');
