 ...
 *     pnpm vitest run --project integration services/platform/tests/integration/research-migration-0039.test.ts
 */
...
const MIGRATION_SQL = resolve(
  REPO_ROOT,
  'services/platform/src/db/migrations/0039_research_pipeline.sql'
);
