...
export const GATE_REGISTRY: readonly GateRegistryEntry[] = [
  {
    ...
    negative_control: 'services/platform/tests/fixtures/verifier-teeth/assets_missing_blob',
  },
  {
    ...
    negative_control: 'services/platform/tests/fixtures/verifier-teeth/rehost_throw_only',
  },
  {
    ...
    negative_control: 'services/platform/tests/fixtures/verifier-teeth/reconcile_planted_variance',
  },
  {
    id: 'verify-no-shells',
    ...
    negative_control: 'services/platform/tests/fixtures/verifier-teeth/no_shells_residue',
  },
  {
    id: 'etl-fk-audit',
    ...
    negative_control: 'services/platform/tests/fixtures/verifier-teeth/fk_audit_zero_constraints',
  },
] as const;
