...
export function renderDeploymentOverride(options: {
  ...
  // Edge (Caddy) owns loopback 44111 per the base Compose contract and
  // reverse-proxies to mastra:4111; Tailscale Serve (D08-07) fronts edge.
  // The override must NOT re-publish 44111 on mastra — that would double-bind
  // the loopback port and crash edge at compose up.
