...
export type SeamCheckResult = {
  ...
  detail: string;
  /** Concrete citation, e.g. services/platform/src/db/schema/mission.ts:14 */
...
const REL = {
  missionSchema: 'services/platform/src/db/schema/mission.ts',
  evidenceSchema: 'services/platform/src/db/schema/evidence.ts',
  documentsSchema: 'services/platform/src/db/schema/documents.ts',
  evidenceGate: 'services/platform/src/research/evidence-gate.ts',
  evidenceResearchTemplate: 'services/platform/src/mission/templates/evidence-research.ts',
  documentPublish: 'services/platform/src/mission/document-publish.ts',
} as const;
