# Holocron Project Rules

This file is the single source of truth for all project rules, conventions, and policies. This file is the directory system prompt.
...
`AGENTS.md`, source code, commits, or review artifacts.
...
`BACKUP_R2_SECRET_ACCESS_KEY`, `CF_ACCESS_CLIENT_ID`, `CF_ACCESS_CLIENT_SECRET`,
`CF_TUNNEL_TOKEN`, `CLOUDFLARE_API_TOKEN`, `DEEPGRAM_API_KEY`, `DEEPSEEK_API_KEY`,
`ELEVENLABS_API_KEY`, `EXPO_PUBLIC_RN_API_KEY`, `EXPO_TOKEN`, `LANGFUSE_AUTH_HEADER`,
`LANGFUSE_CLICKHOUSE_PASSWORD`, `LANGFUSE_ENCRYPTION_KEY`, `LANGFUSE_INIT_USER_PASSWORD`,
`LANGFUSE_NEXTAUTH_SECRET`, `LANGFUSE_POSTGRES_PASSWORD`, `LANGFUSE_PUBLIC_KEY`,
`LANGFUSE_REDIS_AUTH`, `LANGFUSE_S3_ACCESS_KEY_ID`, `LANGFUSE_S3_SECRET_ACCESS_KEY`,
`LANGFUSE_SALT`, `LANGFUSE_SECRET_KEY`, `OPENROUTER_API_KEY`, `R2_RESTORE_ACCESS_KEY_ID`,
`R2_RESTORE_SECRET_ACCESS_KEY`, `R2_SCOPE_PROBE_IN_KEY`, `R2_SCOPE_PROBE_OUT_KEY`,
`YOUTUBE_API_KEY`, and `ZAI_API_KEY`.
...
`DATABASE_URL`, `FLEET_KEY`, `HOLO_KEY_CONTROL`, `HOLO_KEY_MCP`, `HOLO_KEY_RN`,
`LANGFUSE_AUTH_HEADER`, `LANGFUSE_CLICKHOUSE_PASSWORD`, `LANGFUSE_DATABASE_URL`,
`LANGFUSE_ENCRYPTION_KEY`, `LANGFUSE_INIT_USER_PASSWORD`, `LANGFUSE_NEXTAUTH_SECRET`,
`LANGFUSE_POSTGRES_PASSWORD`, `LANGFUSE_PUBLIC_KEY`, `LANGFUSE_REDIS_AUTH`,
`LANGFUSE_S3_ACCESS_KEY_ID`, `LANGFUSE_S3_SECRET_ACCESS_KEY`, `LANGFUSE_SALT`,
`LANGFUSE_SECRET_KEY`, `MASTRA_API_KEY`, `R2_ACCESS_KEY_ID`, `R2_SECRET_ACCESS_KEY`,
`R2_RESTORE_ACCESS_KEY_ID`, `R2_RESTORE_SECRET_ACCESS_KEY`, `R2_RESTORE_SESSION_TOKEN`,
`R2_REPO_CIPHER_PASS`, `RESTIC_PASSWORD`, `TAILSCALE_AUTH_KEY`, and `ZERO_ADMIN_PASSWORD`.
