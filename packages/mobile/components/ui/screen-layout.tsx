...
export function ScreenLayout({
  ...
  const insetStyles = {
    ...
    [mode === 'padding' ? 'paddingBottom' : 'marginBottom']: edgeArray.includes('bottom')
      ? insets.bottom
      : 0,
    [mode === 'padding' ? 'paddingLeft' : 'marginLeft']: edgeArray.includes('left')
      ? insets.left
      : 0,
    [mode === 'padding' ? 'paddingRight' : 'marginRight']: edgeArray.includes('right')
      ? insets.right
      : 0,
  };
