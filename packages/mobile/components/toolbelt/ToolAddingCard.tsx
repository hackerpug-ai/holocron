...
import { Link, Wrench } from '@/components/ui/icons';
...
export function ToolAddingCard({ data, testID = 'tool-adding-card' }: ToolAddingCardProps) {
    ...
    <Card testID={testID} className="border-border bg-card overflow-hidden">
      ...
      <View className="p-4">
        ...
        <View className="mb-3 flex-row items-center gap-2">
          ...
          <Text className="text-foreground flex-1 text-lg font-bold">Adding Tool</Text>
        </View>
