...
#
#   bash packages/platform/deploy/fleet/provision-fulcrum-roles.sh --node inference1
#   bash packages/platform/deploy/fleet/provision-fulcrum-roles.sh --node inference2 \
#     --clear-coder-weights
#
