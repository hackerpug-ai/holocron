 ...
 *     pnpm vitest run packages/platform/tests/integration/inference-telemetry.test.ts
 */
...
const MISSING_ANTHROPIC_DEPENDENCY =
  ...
  'Provide via process.env, packages/platform/config/secrets.yaml, or repo-root .env. ' +
