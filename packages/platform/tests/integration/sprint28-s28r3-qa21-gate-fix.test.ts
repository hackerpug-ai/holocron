...
const PROD_RESTORE = resolve(REPO_ROOT, 'packages/platform/src/backup/restore.ts');
const PROD_BASELINE = resolve(REPO_ROOT, 'packages/platform/src/backup/recovery-baseline.ts');
const PROD_FIRE_DRILL_TS = resolve(REPO_ROOT, 'packages/platform/src/backup/fire-drill.ts');
const PROD_RESTIC_MIRROR = resolve(REPO_ROOT, 'packages/platform/src/backup/restic-mirror.ts');
