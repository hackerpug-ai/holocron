...
describe('AC-5 replication readiness integration (real Postgres)', () => {
  it('GREEN: zero_pub correct — no passages/vectors; REPLICA IDENTITY DEFAULT; wal logical', async () => {
  ...
  it('NEGATIVE: adding passages to zero_pub makes repl:status fail closed', async () => {
  ...
  it('NEGATIVE: REPLICA IDENTITY NOTHING on a published table fails repl:status', async () => {
