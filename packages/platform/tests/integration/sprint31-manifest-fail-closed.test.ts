 ...
 *     packages/platform/tests/integration/sprint31-manifest-fail-closed.test.ts
 */
...
const COMMITTED_MANIFEST = resolve(REPO_ROOT, 'packages/platform/fleet/manifest.json');
