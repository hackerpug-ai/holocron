 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run packages/platform/tests/integration/sprint28-s28r3-qa1-gate-fix.test.ts
 *   pnpm vitest run packages/platform/tests/integration/sprint28-s28r3-qa1-gate-fix.test.ts
 */
