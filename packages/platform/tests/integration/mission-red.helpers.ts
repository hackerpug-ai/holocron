...
export const FIXTURES_DIR = resolve(REPO_ROOT, 'packages/platform/tests/fixtures/mission-engine');
export const PLATFORM_SRC_DIR = resolve(REPO_ROOT, 'packages/platform/src');
