 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run packages/platform/tests/integration/redhat-fix-h5-exact-restore-arns.test.ts
 */
...
const CONFIG_TS = resolve(REPO_ROOT, 'packages/platform/src/backup/config.ts');
