 ...
 *     pnpm test:integration packages/platform/tests/integration/s33-plat-02-fleet-base-resolution.test.ts
 */
...
const MANIFEST_PATH = resolve(REPO_ROOT, 'packages/platform/fleet/manifest.json');
