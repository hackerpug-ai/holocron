 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run packages/platform/tests/integration/sprint31-langfuse-in-repo.test.ts
 */
...
const COMPOSE = resolve(REPO_ROOT, 'packages/platform/deploy/compose/langfuse.compose.yaml');
const PLIST = resolve(REPO_ROOT, 'packages/platform/deploy/launchd/holocron-langfuse.plist');
