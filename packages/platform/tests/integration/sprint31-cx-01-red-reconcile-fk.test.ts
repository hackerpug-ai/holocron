 ...
 *     pnpm test:integration -- packages/platform/tests/integration/sprint31-cx-01-red-reconcile-fk.test.ts
 */
...
const FIXTURE_DIR = resolve(REPO_ROOT, 'packages/platform/tests/fixtures/s31-cx-01');
