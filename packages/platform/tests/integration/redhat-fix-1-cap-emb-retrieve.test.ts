 ...
 *   pnpm vitest run packages/platform/tests/integration/redhat-fix-1-cap-emb-retrieve.test.ts
 */
...
const RUNTIME_PATH = resolve(REPO_ROOT, 'packages/platform/src/mission/runtime.ts');
