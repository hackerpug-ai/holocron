...
SECRETS=""
for c in "$ROOT/packages/platform/config/secrets.yaml" "\${HOLO_QA27_SECRETS_PATH:-}" "\${HOLOCRON_SECRETS_PATH:-}" "\${HOLO_SECRETS_PATH:-}" "/Users/inference1/Projects/holocron/packages/platform/config/secrets.yaml"; do
