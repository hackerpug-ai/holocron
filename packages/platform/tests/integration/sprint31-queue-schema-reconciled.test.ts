 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run packages/platform/tests/integration/sprint31-queue-schema-reconciled.test.ts
 */
...
const QUEUE_SCHEMA = resolve(REPO_ROOT, 'packages/platform/src/queue/schema.ts');
