 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run packages/platform/tests/integration/sprint28-recovery-baseline.test.ts
 */
...
const MODULE_PATH = resolve(REPO_ROOT, 'packages/platform/src/backup/recovery-baseline.ts');
