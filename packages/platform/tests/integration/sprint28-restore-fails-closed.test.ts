 ...
 *
 * Run:
 *   PLATFORM_IT=1 pnpm vitest run packages/platform/tests/integration/sprint28-restore-fails-closed.test.ts
 */
...
const RESTORE_MODULE = resolve(REPO_ROOT, 'packages/platform/src/backup/restore.ts');
