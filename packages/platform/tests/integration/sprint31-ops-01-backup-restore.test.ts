 ...
 *     packages/platform/tests/integration/sprint31-ops-01-backup-restore.test.ts
 */
...
const LAUNCHD_DIR = resolve(REPO_ROOT, 'packages/platform/deploy/launchd');
...
const EXAMPLE_CONF = resolve(REPO_ROOT, 'packages/platform/deploy/nonprod/pgbackrest.conf.example');
