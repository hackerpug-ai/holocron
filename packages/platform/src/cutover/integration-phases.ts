...
export const INTEGRATION_PHASES: readonly IntegrationPhase[] = [
  {
    ...
    includes: [
      'packages/platform/tests/integration/sprint29-compose-contract.test.ts',
      ...
      'packages/platform/tests/integration/sprint29-human-gate-freshness.test.ts',
      'packages/platform/tests/integration/prd-consistency.test.ts',
      'packages/platform/tests/integration/red-no-shells.test.ts',
    ],
  },
  {
    name: 'postgres',
    includes: [
      ...
      'packages/platform/tests/integration/queue-dlq.test.ts',
      'packages/platform/tests/integration/queue-priority.test.ts',
      'packages/platform/tests/integration/sprint14-etl-and-blob.test.ts',
      'packages/platform/tests/integration/sprint29-cutover-etl.test.ts',
      'packages/platform/tests/integration/sprint29-soak-flip.test.ts',
      ...
      'packages/platform/tests/integration/sprint28-pitr-recovery-contract.test.ts',
      'packages/platform/tests/integration/redhat-fix-1-cap-emb-retrieve.test.ts',
      'packages/platform/tests/integration/rrf-search.test.ts',
      'packages/platform/tests/integration/search-recall.test.ts',
      'packages/platform/tests/integration/inline-surfaces-search.test.ts',
      'packages/platform/tests/integration/embed-helper.test.ts',
      'packages/platform/tests/integration/embed-run.test.ts',
    ],
  ...
  },
  {
    name: 'zero',
    includes: [
      'packages/platform/tests/integration/nonprod-namespace-zero-sync.test.ts',
      'packages/platform/tests/integration/sprint20-reference-zero-durable.test.ts',
      'packages/platform/tests/integration/sprint20-chat-zero-boundary.test.ts',
      'packages/platform/tests/integration/sprint29-zero-file-objects-permissions.test.ts',
    ...
    ready: (env) => {
      ...
      const holo = resolve(env.HOLO_ROOT ?? process.cwd(), 'packages/platform/src/cli/holo.ts');
  ...
  },
  {
    name: 'fleet-retailer',
    includes: [
      'packages/platform/tests/integration/mission-engine-red.test.ts',
      'packages/platform/tests/integration/sprint19-mcp-rehost.test.ts',
      'packages/platform/tests/integration/sprint25-chat-fleet-only-mock.test.ts',
      'packages/platform/tests/integration/pipeline-templates.test.ts',
      ...
      'packages/platform/tests/integration/business-report-template.test.ts',
      'packages/platform/tests/integration/inference-telemetry.test.ts',
      'packages/platform/tests/integration/redhat-fix-h3-multi-axis-isolation.test.ts',
      'packages/platform/tests/integration/redhat-fix-h4-sacrificial-credential-negative.test.ts',
      'packages/platform/tests/integration/redhat-fix-h5-exact-restore-arns.test.ts',
    ],
    ready: (env) => {
      requirePostgres(env);
  ...
  },
  {
    ...
    includes: [
      ...
      'packages/platform/tests/integration/sprint20-maestro-harness-artifacts.test.ts',
    ],
    ready: (env) => {
      requirePostgres(env);
      requireZero(env);
