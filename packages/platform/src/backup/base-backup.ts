...
<dict>
	...
	<array>
		...
		<string>${options.holoRoot}/packages/platform/src/cli/holo.ts</string>
 ...
 * Template also written under packages/platform/deploy/launchd for version control.
 */
export function installBaseBackupLaunchd(options?: {
  ...
  const templateDir = resolve(holoRoot, 'packages/platform/deploy/launchd');
...
<dict>
	...
	<array>
		...
		<string>@HOLO_ROOT@/packages/platform/src/cli/holo.ts</string>
		<string>backup:base</string>
		<string>--json</string>
	</array>
	<key>WorkingDirectory</key>
