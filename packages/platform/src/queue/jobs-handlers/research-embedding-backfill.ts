...
const runresearchEmbeddingBackfill: JobHandler = async (ctx): Promise<JobHandlerResult> => {
...
export const researchEmbeddingBackfill: JobHandler = (ctx) => withDbRetry(() => runresearchEmbeddingBackfill(ctx));
