...
export interface HonoRoute {
  ...
  path: string;
  /** Live purpose — quoted from packages/platform/src/http/hono-app.ts. */
  purpose: string;
}
...
export function authorContract(options: AuthorOptions): ClientDataContract {
  ...
  return {
    ...
    generated_from: {
      ...
      zero_pub: 'packages/platform/src/db/schema/zero-pub.ts',
      hono_routes: 'packages/platform/src/http/hono-app.ts',
