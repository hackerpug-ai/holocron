 ...
 * - packages/platform/src/chat/specialists.ts (+ triage, http/chat-runs)
 *   replaces convex/chat/specialists.ts
 * - packages/platform/src/queue/jobs-handlers/* (task-timeout-worker et al.)
 ...
 * - chat specialists → packages/platform/src/chat/specialists.ts (used by http/chat-runs)
 * - task timeout crons → packages/platform/src/queue/jobs-handlers/task-timeout-worker.ts
