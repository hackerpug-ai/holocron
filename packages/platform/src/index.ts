 ...
 *
 * Usage:
 *   bun run packages/platform/src/index.ts
 *   bun packages/platform/src/cli/holo.ts service:up
 */
...
// Composition-root entry: `bun run packages/platform/src/index.ts`
const argvEntry = process.argv[1];
const isMain =
  argvEntry !== undefined &&
  (resolve(argvEntry) === fileURLToPath(import.meta.url) ||
    argvEntry.endsWith('/packages/platform/src/index.ts') ||
    argvEntry.endsWith('packages/platform/src/index.ts') ||
